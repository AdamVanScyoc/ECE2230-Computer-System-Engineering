...
#include "novel.h" // needed for definition of structWord - which will be the linked-list data
			// and we need to be able to dereference it

/** pointer to opaque list type to be defined in list.c. */
typedef struct list *list;

/** list data pointer. not to be freed by the list. */
typedef struct structWord *list_data;
